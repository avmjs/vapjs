...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3).Buffer, __webpack_require__(56)))
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(52), __webpack_require__(56)))
...
var stripHexPrefix = __webpack_require__(19);
...
"use strict";
'use strict';
var isFn = __webpack_require__(106);
var setImmediate = __webpack_require__(111);
...
/* WEBPACK VAR INJECTION */(function(setImmediate, clearImmediate) {var nextTick = __webpack_require__(52).nextTick;
...
var VapQuery = __webpack_require__(121);
var VapFilter = __webpack_require__(117);
var VapContract = __webpack_require__(115);
...
var unit = __webpack_require__(123);
var keccak256 = __webpack_require__(12).keccak_256;
var toBN = __webpack_require__(13);
var BN = __webpack_require__(8);
var utils = __webpack_require__(34);
var getTransactionSuccess = __webpack_require__(58);
...
function Vap(cprovider, options) {
  if (!(this instanceof Vap)) {
    throw new Error('[vapjs] the Vap object requires you construct it with the "new" flag (i.e. `const vap = new Vap(...);`).');
  }
  var self = this;
  self.options = options || {};
  var query = new VapQuery(cprovider, self.options.query);
...
Vap.BN = BN;
Vap.isAddress = function (val) {
  return utils.isHexString(val, 20);
};
Vap.keccak256 = function (val) {
...
module.exports = function (vap) {
  return function (txHash, callback) {
    var count = 0;

    var timeout = vap.options.timeout || 800000;
    var interval = vap.options.interval || 7000;
...
Note, Richard is a god of ether gods. Follow and respect him, and use Vapers.io!
*/
...
var abi = __webpack_require__(54); // eslint-disable-line
var VapFilter = __webpack_require__(55); // eslint-disable-line
var getKeys = __webpack_require__(34).getKeys; // eslint-disable-line
var keccak256 = __webpack_require__(12).keccak_256; // eslint-disable-line
var hasTransactionObject = __webpack_require__(53);
...
var schema = __webpack_require__(108);
...
var format = __webpack_require__(118);
var VapRPC = __webpack_require__(122);
var promiseToCallback = __webpack_require__(32);
...
(0, _keys2['default'])(format.schema.methods).forEach(function (rpcMethodName) {
  (0, _defineProperty2['default'])(Vap.prototype, rpcMethodName.replace('vap_', ''), {
    enumerable: true,
...
function generateFnFor(rpcMethodName, methodObject) {
  return function outputMethod() {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                throw new Error('[vapjs-query] method \'' + protoMethodName + '\' requires at most ' + methodObject[0].length + ' params, ' + args.length + ' provided \'' + (0, _stringify2['default'])(args, null, self.options.jsonSpace) + '\'. For more information visit: https://github.com/vaporyco/wiki/wiki/JSON-RPC#' + rpcMethodName.toLowerCase());
              ...
              case 11:
                ...
                throw new Error('[vapjs-query] while formatting inputs \'' + (0, _stringify2['default'])(args, null, this.options.jsonSpace) + '\' for method \'' + protoMethodName + '\' error: ' + _context.t0);
              ...
              case 24:
                ...
                outputError = new Error('[vapjs-query] while formatting outputs from RPC \'' + (0, _stringify2['default'])(result, null, this.options.jsonSpace) + '\' for method \'' + protoMethodName + '\' ' + _context.t1);
                throw outputError;
    ...
    var self = this;
    var args = [].slice.call(arguments); // eslint-disable-line
    var protoMethodName = rpcMethodName.replace('vap_', ''); // eslint-disable-line
...
function getValueOfUnit(unitInput) {
  var unit = unitInput ? unitInput.toLowerCase() : 'vapor';
...
function toWei(vaporInput, unit) {
  ...
  if (vapor === '.') {
    throw new Error('[vapjs-unit] while converting number ' + vaporInput + ' to wei, invalid value');
  }

  // Split it into a whole and fractional part
  var comps = vapor.split('.'); // eslint-disable-line
  if (comps.length > 2) {
    throw new Error('[vapjs-unit] while converting number ' + vaporInput + ' to wei,  too many decimal points');
  }
  ...
  if (fraction.length > baseLength) {
    throw new Error('[vapjs-unit] while converting number ' + vaporInput + ' to wei, too many decimal places');
  }
...
/* WEBPACK VAR INJECTION */(function(Buffer) {const isHexPrefixed = __webpack_require__(31);
const stripHexPrefix = __webpack_require__(19);
 ...
 */
function arrayContainsArray(superset, subset, some) {
  if (Array.isArray(superset) !== true) { throw new Error(`[vapjs-util] method arrayContainsArray requires input 'superset' to be an array got type '${typeof superset}'`); }
  if (Array.isArray(subset) !== true) { throw new Error(`[vapjs-util] method arrayContainsArray requires input 'subset' to be an array got type '${typeof subset}'`); }
 ...
 */
function getKeys(params, key, allowEmpty) {
  if (!Array.isArray(params)) { throw new Error(`[vapjs-util] method getKeys expecting type Array as 'params' input, got '${typeof params}'`); }
  if (typeof key !== 'string') { throw new Error(`[vapjs-util] method getKeys expecting type String for input 'key' got '${typeof key}'.`); }
